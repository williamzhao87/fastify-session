...
* `secureAutoHeaders` - When `secure` is set to `auto`, you can optionally add this comma separtaes `string` array to specify which headers to check for http or https, if not found, default to checking `x-forwarded-proto`
