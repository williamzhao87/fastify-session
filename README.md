...
* `secureAutoHeader` - When `secure` is set to `auto`, you can optionally add this `string` value to specify which header to check for http or https, if not found, default to checking `x-forwarded-proto`
